...
$(call inherit-product, device/wisky/wisky8163_tb_m/device.mk)
...
PRODUCT_NAME := full_wisky8163_tb_m
PRODUCT_DEVICE := wisky8163_tb_m
PRODUCT_MODEL := wisky8163_tb_m
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= wisky8163_tb_m_debug_defconfig
else
KERNEL_DEFCONFIG ?= wisky8163_tb_m_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= wisky8163_tb_m
LK_PROJECT ?= wisky8163_tb_m
TRUSTY_PROJECT ?= wisky8163_tb_m
