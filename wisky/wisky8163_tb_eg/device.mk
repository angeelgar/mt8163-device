...
#PRODUCT_COPY_FILES += device/wisky/$(MTK_TARGET_PROJECT)/enableswap.sh:root/enableswap.sh
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/images/lcd_test_00_gmo.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/images/lcd_test_01_gmo.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/images/lcd_test_02_gmo.png:system/res/images/lcd_test_02.png

MTK_ART_OPT_LOW_RAM_MODE := true

PRODUCT_COPY_FILES += device/wisky/$(MTK_TARGET_PROJECT)/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml
PRODUCT_COPY_FILES += device/wisky/$(MTK_TARGET_PROJECT)/handheld_core_hardware.xml:system/etc/permissions/handheld_core_hardware.xml
PRODUCT_COPY_FILES += device/wisky/$(MTK_TARGET_PROJECT)/mtk_omx_core.cfg:system/etc/mtk_omx_core.cfg
...
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/handheld_core_hardware.xml:system/etc/permissions/handheld_core_hardware.xml

# Thermal
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/thermal.conf:system/etc/.tp/thermal.conf
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/thermal.off.conf:system/etc/.tp/thermal.off.conf
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/ht120.mtc:system/etc/.tp/.ht120.mtc
...
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/ueventd.mt8163.rc:root/ueventd.mt8163.rc

PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/meta_init.project.rc:root/meta_init.project.rc
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/init.recovery.mt8163.rc:root/init.recovery.mt8163.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/wisky/wisky8163_tb_eg/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif
...
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8163_tb_eg/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8163_tb_eg/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt8163/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8163_tb_eg/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8163_tb_eg/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/wisky8163_tb_eg/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png


# USB
PRODUCT_COPY_FILES += device/wisky/wisky8163_tb_eg/init.mt8163.usb.rc:root/init.mt8163.usb.rc
...
# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/wisky/wisky8163_tb_eg/overlay
