...
include device/yongyida/$(MTK_TARGET_PROJECT)/ProjectConfig.mk
...
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/handheld_core_hardware.xml:system/etc/permissions/handheld_core_hardware.xml

# Thermal
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/thermal.conf:system/etc/.tp/thermal.conf
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/thermal.off.conf:system/etc/.tp/thermal.off.conf
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/ht120.mtc:system/etc/.tp/.ht120.mtc

# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/yongyida/$(MTK_TARGET_PROJECT)/overlay
DEVICE_PACKAGE_OVERLAYS += device/yongyida/$(MTK_BASE_PROJECT)/overlay
...
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/ueventd.mt8163.rc:root/ueventd.mt8163.rc
...
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/yongyida/yyd8163_tb_m/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif

# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/yongyida/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/yongyida/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/yongyida/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/yongyida/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/yongyida/$(MTK_TARGET_PROJECT)/MT8163_Android_scatter.txt:MT8163_Android_scatter.txt
...
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/yyd8163_tb_m/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/yyd8163_tb_m/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt8163/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/yyd8163_tb_m/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/yyd8163_tb_m/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/yyd8163_tb_m/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png


# USB
PRODUCT_COPY_FILES += device/yongyida/yyd8163_tb_m/init.mt8163.usb.rc:root/init.mt8163.usb.rc
...
# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/yongyida/yyd8163_tb_m/overlay
...
$(call inherit-product-if-exists, vendor/yongyida/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
