...
ifeq ($(MTK_BLUE_LIGHT_FILTER_SUPPORT),yes)
	PRODUCT_PACKAGES += libblf
	PRODUCT_PACKAGES += libjni_blf
	PRODUCT_PACKAGES += BlueLightFilter
endif
...
ifeq ($(strip $(MTK_GPU_SUPPORT)), yes)
  ifeq ($(MTK_PLATFORM),$(filter $(MTK_PLATFORM),MT8163))
    ifeq ($(strip $(MTK_INHOUSE_GPU)), yes)
      PRODUCT_PACKAGES += gralloc.mt8163
      PRODUCT_PACKAGES += libG3D
      PRODUCT_PACKAGES += libgpu_llvm
      PRODUCT_PACKAGES += libgl_compiler
      PRODUCT_PACKAGES += libGLAPI
      PRODUCT_PACKAGES += libEGL_yoli
      PRODUCT_PACKAGES += libGLESv1_CM_yoli
      PRODUCT_PACKAGES += libGLESv2_yoli
      PRODUCT_PACKAGES += mtune
      PRODUCT_PACKAGES += gpadd
      PRODUCT_PACKAGES += libgp_api
    else
      PRODUCT_PACKAGES += gralloc.mt8163
...
ifeq ($(strip $(MTK_WVDRM_SUPPORT)),yes)
  ...
  ifeq ($(strip $(MTK_WVDRM_L1_SUPPORT)),yes)
    ...
    PRODUCT_PROPERTY_OVERRIDES += wvdrm_l1_enable=true
...
PRODUCT_COPY_FILES += device/mediatek/mt8163/init.mt8163.rc:root/init.mt8163.rc
PRODUCT_COPY_FILES += device/mediatek/mt8163/factory_init.rc:root/factory_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8163/init.modem.rc:root/init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt8163/ueventd.mt8163.rc:root/ueventd.mt8163.rc

ifeq ($(strip $(MTK_FAT_ON_NAND)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8163/init.fon.rc:root/init.fon.rc
endif

PRODUCT_COPY_FILES += device/mediatek/mt8163/init.xlog.rc:root/init.xlog.rc
PRODUCT_COPY_FILES += device/mediatek/mt8163/meta_init.modem.rc:root/meta_init.modem.rc
PRODUCT_COPY_FILES += device/mediatek/mt8163/meta_init.rc:root/meta_init.rc
PRODUCT_COPY_FILES += device/mediatek/mt8163/egl.cfg:system/lib/egl/egl.cfg
...
PRODUCT_COPY_FILES += external/mic5/pro_fea_algo.iea:system/lib/pro_fea_algo.iea
...
PRODUCT_COPY_FILES += external/mic5/RS20.bin:system/lib/RS20.bin
PRODUCT_COPY_FILES += external/mic5/Y50E.bin:system/lib/Y50E.bin
...
PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_mediatek_audio.xml:system/etc/media_codecs_mediatek_audio.xml
ifeq ($(strip $(MTK_WVDRM_L1_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_mediatek_video_wvl1.xml:system/etc/media_codecs_mediatek_video.xml
else
PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs_mediatek_video.xml:system/etc/media_codecs_mediatek_video.xml
endif

PRODUCT_COPY_FILES += device/mediatek/mt8163/media_codecs.xml:system/etc/permissions/media_codecs.xml
ifeq ($(strip $(MTK_WVDRM_L1_SUPPORT)),yes)
PRODUCT_COPY_FILES += device/mediatek/mt8163/mtk_omx_core_wvl1.cfg:system/etc/mtk_omx_core.cfg
else
PRODUCT_COPY_FILES += device/mediatek/mt8163/mtk_omx_core.cfg:system/etc/mtk_omx_core.cfg
endif
...
#Audio config
PRODUCT_COPY_FILES += device/mediatek/mt8163/audio_device.xml:system/etc/audio_device.xml

#SensorHub
ifeq ($(MTK_SENSOR_HUB_SUPPORT),yes)
