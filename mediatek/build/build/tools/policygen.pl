...
foreach $xmlfile (@relPackages) {
    ...
    for (my $i = 0; $i < $n; $i++) {
        ...
        push(@dirList_r,$value) if (defined($value) && (none {$_ eq $value } @dirList_r));
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@dirList_u,$value) if (defined($value) &&  (none {$_ eq $value } (@dirList_r,@dirList_u)));
        @dirList_removal = grep (!/^$value$/,@dirList_removal) if ((any {$_ eq $value} @dirList_removal));
    }
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@dirList_removal,$value) if (defined($value) && (none {$_ eq $value } (@dirList_r,@dirList_removal,@dirList_u)));
    }
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue  if (defined($node));
        push(@fileList_r,$value) if (defined($value) && (none {$_ eq $value } @fileList_r));
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@fileList_u,$value)  if (defined($value) && (none {$_ eq $value } @fileList_u));
    }
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@frameworkList_s,$value)  if (defined($value) && (none {$_ eq $value } @frameworkList_s));
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@frameworkList_b,$value) if (defined($value) && (none {$_ eq $value } @frameworkList_b));
    }
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        $value =~ s#\{COMPANY\}#$company#;
        $value =~ s#\{PROJECT\}#$prjname#;
        $value =~ s#\{BASE_PROJECT\}#$BaseProject# if($BaseProject);
        push(@androidList_s,$value) if (defined($value) && (none {$_ eq $value } @androidList_s));
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@androidList_b,$value) if (defined($value)&& (none {$_ eq $value } @androidList_b));
    }
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@appList_s,$value) if (defined($value)&&  (none {$_ eq $value } @appList_s));
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@appList_b,$value) if (defined($value)&& (none {$_ eq $value } @appList_b));
    }
    ...
    for (my $i = 0; $i < $n; $i++) {
        my $node = $nodes->item ($i)->getChildNodes()->item(0);
        my $value = $node->getNodeValue if (defined($node));
        push(@kernelList,@value) if (defined($value) && (none {$_ eq $value } @kernelList));
    }
